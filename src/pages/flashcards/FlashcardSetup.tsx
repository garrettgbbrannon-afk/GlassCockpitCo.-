  ...
  return (
    <div className="min-h-screen bg-panel-950">
      ...
      <main className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <p className="mt-2 text-silver-400">Pick a deck. Tap a card to flip it and see the answer.</p>

        <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
          <button
            type="button"
            onClick={() => start("all")}
            className="rounded-xl border border-panel-700 bg-panel-900/60 px-4 py-4 text-left text-sm font-medium text-silver-200 transition-colors hover:border-accent-500/60"
          >
